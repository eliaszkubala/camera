...
import kamera.preview.ui.ListWrapperRenderer;
import kamera.preview.ui.ProjectPreview;
...
public class PreviewWindow {
    ...
    public static void main(final String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                chart2d = new Chart2d();
                new PreviewWindow(projectPath);
            }
        });
    }

    public PreviewWindow(String projectPath) {
                ...
                if (fileName.contains(currentFileName))
                    if (fileName.contains(".txt")) {
                        ...
                        if (fileName.contains("gyroData")) {
                            ...
                            chart2d.saveImage(ProjectRequest.getDirOfProject(projectPath) + "\\" + currentFileName);
                        }
    ...
    MouseAdapter mouseAdapter = new MouseAdapter() {
        ...
        public void mouseClicked(MouseEvent event) {
            ...
            if (event.getClickCount() == 2) {
                ...
                File outputfile = new File(GlobalData.getCurrentProjectFile() + "\\" + EventWindow.getSnapshotName(currentFileName, second));
                try {
                    ImageIO.write(bi, "png", outputfile);
                } catch (IOException e) {
                    e.printStackTrace();
                }
                EventWindow.openWindow(currentFileName, second);
    ...
    private void addListeners() {
        ...
        getGUI().getGenerateReports().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    new PdfCreateor(projectPath, projectPath);
            ...
            public void mousePressed(MouseEvent e) {
                ...
                if (SwingUtilities.isRightMouseButton(e)) {
                    ...
                    delete.addActionListener(new ActionListener() {
                        ...
                        public void actionPerformed(ActionEvent e) {
                            mediaPlayer.stop();
                            ProjectRequest.getInstance().removeProjectByPath(path);
                            try {
                                addItems();
