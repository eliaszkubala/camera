...
public class PdfCreateor {
    ...
    public PdfCreateor(String projectName, String outputPDFName) throws IOException, DocumentException {

        LogsSender.send(LogsSender.LogsIntCode.WYGENEROWANO_RAPORT, LogsSender.LogsString.WYGENEROWANO_RAPORT + " " + projectName);

        File outputPDFFile = new File(System.getProperty("user.home") + "\\Desktop\\" + outputPDFName + ".pdf");

        String dir = ProjectRequest.getDirOfProject(projectName).getPath();
    ...
    public static void main(String[] args) throws IOException {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    new PdfCreateor("Projekt testowy", "Projekt testowy");
