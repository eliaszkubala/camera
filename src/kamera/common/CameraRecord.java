...
public abstract class CameraRecord implements CameraRecordInterface {
    private static final String RTSP_CAMERA_ADDRESS = "rtsp://192.168.1.88:8557/Onvif/Streaming/2?videoCodecType=H.264";
    ...
    public void startPreview() {
        ...
        getMediaPlayer().playMedia(RTSP_CAMERA_ADDRESS, options);
    }
    ...
    public void startNewRecord() {
        ...
        getMediaPlayer().playMedia(RTSP_CAMERA_ADDRESS, optionsRecord);
        LogsSender.send(LogsSender.LogsIntCode.ROZPOCZETO_INSPEKCJE, LogsSender.LogsString.ROZPOCZETO_INSPEKCJE + " " + GlobalData.getCurrentProjectName() + ":" + GlobalData.getLastRecordFileName());
