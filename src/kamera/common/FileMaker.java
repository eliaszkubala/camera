...
public class FileMaker {
    ...
    public void serialEvent(String inputLine) {
        ...
        if (data[0].equals("gyro")) {
            String y = RS485Reader.getInstance().getGYROSCOPE_DATA();
        ...
        if (data[0].equals("dis")) {
            String distance = RS485Reader.getInstance().getDISTANCE_DATA();
    ...
    class SayHello extends TimerTask {
        public void run() {
            ...
            if (seconds % 1 == 0) {
                ...
                //kamera.common.RS485Reader.getInstance().write("getGyro()");
                RS485Reader.getInstance().setListener(FileMaker.this);
            }
        }
    }
}
